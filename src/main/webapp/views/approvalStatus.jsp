...
<html>
<head>
    <title>ApprovalStatus-Template</title>
    <style>
        body{
            display: block;
            margin: 10px;
...
<div class="container">
    <div style="width: 100%">
        ...
        <div class="card">
            ...
            <p>
                Your {leaveType} request from {employee name} for  {number of days} days  from {start date} to {end date}
                has been {approvalStatus} by {Manager Name }
            </p>
